...
| `/api/models` | GET | Returns the available Gemma 4 model for Field Guide. |
| `/api/chat` | POST | Main chat endpoint for Field Guide. |
| `/api/stream` | POST | Streaming chat endpoint for Field Guide. |
