...
| Preserve Markdown structure and styling in native saved/shared Field Guide PDFs | Implemented after `49d6f96`; physical test confirmed formatting restoration. Candidate now uses a taller/narrower mobile page, 15.2-point body text, earlier wrapping, and hanging list indents | Rebuild/reinstall Dev candidate and visually inspect short, long, list-heavy, and multi-page PDFs; reconfirm from Play internal test |
